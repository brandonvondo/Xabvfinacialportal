...
namespace Xabvfinacialportal.Controllers
{
    ...
    public class BankAccountsController : Controller
    {
        ...
        {
            var bankAccounts = db.BankAccounts.Include(b => b.Household).Include(b => b.User);
        ...
        public ActionResult Create([Bind(Include = "Id,HouseholdId,UserId,AccountName,Created,CreatedString,StartingBalance,CurrentBalance,WarningBalance,IsDeleted,AccountType")] BankAccount bankAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,UserId,AccountName,Created,CreatedString,StartingBalance,CurrentBalance,WarningBalance,IsDeleted,AccountType")] BankAccount bankAccount)
        {
            if (ModelState.IsValid)
            {
