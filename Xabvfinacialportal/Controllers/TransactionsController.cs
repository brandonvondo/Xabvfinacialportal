...
namespace Xabvfinacialportal.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        {
            ViewBag.AccountId = new SelectList(db.BankAccounts, "Id", "UserId");
        ...
        public ActionResult Create([Bind(Include = "Id,AccountId,BudgetItemId,UserId,TransactionType,Created,Amount,Memo,IsDeleted")] Transaction transaction)
        {
